...
~H"""
    <div phx-click="play" phx-value-song_id={@id} class="grid grid-cols-4 m-3 gap-x-[1rem] m-0 p-3 rounded-xl mx-2 hover:bg-neutral-900">
      <img class="rounded-2xl" src={BluetoothAmpWeb.B3.get_url(@album_cover)} />
