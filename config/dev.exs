...
config :bluetooth_amp_web, BluetoothAmpWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Yx1v+81HKaEB4ByyRNrTTWSW9jv2nYQLr7Mpcv1SN30UALeeIALx8e72VdxZgTpd",
  watchers: [
...
config :bluetooth_amp_web, BluetoothAmpWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/bluetooth_amp_web/(live|views)/.*(ex)$",
      ~r"lib/bluetooth_amp_web/templates/.*(eex)$"
    ]
  ]
